...
#' \code{\link{BFpower.ttest.OneSample}}, \code{\link{BFpower.ttest.TwoSample}},
...
#' \code{\link{BF10.ttest.OneSample}}, \code{\link{BF10.ttest.TwoSample}},
#' \code{\link{BF10.cor}}, \code{\link{BF10.bin.test}}, or
#' \code{\link{BF10.props}}.
#'
...
#'
#' This function can return up to three plots:
#' \itemize{
#'   \item The first plot displays the analysis prior and the design prior.
#'   \item The second plot contains two panels: the left panel shows the true and false positive rates as a function of sample size, while the right panel shows the true and false negative rates.
#'   \item The third plot illustrates the relationship between the data and the Bayes factors.
#' }
#'
#' @param x A \code{"BFpower"} object returned by one of the following functions:
#'   \code{\link{BFpower.ttest.OneSample}},
#'   \code{\link{BFpower.ttest.TwoSample}},
#'   \code{\link{BFpower.f.test}},
#'   \code{\link{BFpower.cor}},
#'   \code{\link{BFpower.bin}},
#'   or \code{\link{BFpower.props}}.
...
plot.BFpower <- function(x, plot_power = FALSE, plot_rel = FALSE,...) {
  ...
  switch(x$type,
         ...
         stop("Unknown analysis type: ", x$type)
  )
