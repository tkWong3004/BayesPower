#' @export
bayespower_t.test_one_sample <- function(interval,
...
#' @export
bayespower_t.test_two_sample <- function(D, r, target, model, location, scale, dff, hypothesis,
                                         model_d, location_d, scale_d, dff_d, de_an_prior,
...
#' @export
bayespower_cor <- function(interval,
                           D, target, model, k, alpha, beta, h0, location, scale, dff,
...
#' @export
bayespower_f <- function(interval,
...
#' @export
bayespower_bin <- function(interval,
...
#' @export
bayespower_props <- function(D,target, a0, b0, a1, b1, a2, b2, r,model1,da1,db1,dp1,model2,da2,db2,dp2,mode_bf,n1,n2,direct) {
