...
// [[Rcpp::export]]
NumericVector t1_BF10(NumericVector t_vec, double df,
...
// t1_BF10
NumericVector t1_BF10(NumericVector t_vec, double df, std::string model, double location, double scale, double dff, std::string hypothesis);
RcppExport SEXP sourceCpp_7_t1_BF10(SEXP t_vecSEXP, SEXP dfSEXP, SEXP modelSEXP, SEXP locationSEXP, SEXP scaleSEXP, SEXP dffSEXP, SEXP hypothesisSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(t1_BF10(t_vec, df, model, location, scale, dff, hypothesis));
