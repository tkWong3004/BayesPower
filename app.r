...
# sourceCpp("Functions/dnct.cpp", cacheDir = "tmp_cache") # slow, had to give up (but no warnings, unlike dt()...)
# sourceCpp("Functions/pnct.cpp", cacheDir = "tmp_cache") # use pt.cpp instead
